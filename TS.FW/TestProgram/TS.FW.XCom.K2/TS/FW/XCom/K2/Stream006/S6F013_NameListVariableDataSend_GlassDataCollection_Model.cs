...
{
    public class S6F13_NameListVariableDataSend_GlassDataCollection_Model : IXComModel
    {
        ...
        public List<S6F13_GlsCnt> GlsCnt { get; set; }

        public Byte RPTID9 { get; set; }

        public List<S6F13_ModuleCnt> ModuleCnt { get; set; }

        public Byte RPTID12 { get; set; }

        public List<S6F13_GlsFlowCnt> GlsFlowCnt { get; set; }

        public S6F13_NameListVariableDataSend_GlassDataCollection_Model()
        {
            this.Stream = 6;
            this.Function = 13;
            this.FullName = "NameListVariableDataSend_GlassDataCollection";
            this.Name = "NameListVariableDataSend_GlassDataCollection";
            this.SubName = "";
            ...
            this.CEID = 0;
            this.RPTID10 = 0;
            this.GlsCnt = new List<S6F13_GlsCnt>();
            this.RPTID9 = 0;
            this.ModuleCnt = new List<S6F13_ModuleCnt>();
            this.RPTID12 = 0;
            this.GlsFlowCnt = new List<S6F13_GlsFlowCnt>();
        }
    }

    public class S6F13_GlsCnt
    {
    ...
    public class S6F13_ModuleCnt
    {
        public string MODULEID { get; set; }

        public List<S6F13_DataCnt> DataCnt { get; set; }

        public S6F13_ModuleCnt()
        {
            this.MODULEID = string.Empty;
            this.DataCnt = new List<S6F13_DataCnt>();
        }
    }

    public class S6F13_DataCnt
    {
        public string DATA_ITEM { get; set; }

        public string DATA_VALUE { get; set; }

        public S6F13_DataCnt()
        {
    ...
    public class S6F13_GlsFlowCnt
    {
        public string FLOW_PATH { get; set; }

        public string FLOW_MODULEID { get; set; }

        public S6F13_GlsFlowCnt()
        {
            this.FLOW_PATH = string.Empty;
            this.FLOW_MODULEID = string.Empty;
        }
    }
}
