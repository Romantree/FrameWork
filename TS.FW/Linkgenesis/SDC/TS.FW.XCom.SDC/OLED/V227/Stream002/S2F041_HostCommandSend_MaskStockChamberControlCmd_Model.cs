...
{
    public class S2F41_HostCommandSend_MaskStockChamberControlCmd_Model : IXComModel
    {
        ...
        public S2F41_HostCommandSend_MaskStockChamberControlCmd_Model()
        {
            this.Stream = 2;
            this.Function = 41;
            this.FullName = "HostCommandSend - MaskStockChamberControlCmd";
