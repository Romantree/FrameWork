...
{
    public class S3F121_GlassUnitInfo_Model : IXComModel
    {
        ...
        public List<S3F121_LIST_1> LIST_1 { get; set; }

        public S3F121_GlassUnitInfo_Model()
        {
            this.Stream = 3;
            this.Function = 121;
            this.FullName = "GlassUnitInfo";
            this.Name = "GlassUnitInfo";
            this.SubName = "";
            ...
            this.BATCH_ORDER = 0;
            this.LIST_1 = new List<S3F121_LIST_1>();
        }
    }

    public class S3F121_LIST_1
    {
