...
{
    public class S7F10_MaterialIDData_Model : IXComModel
    {
        public Byte UINT1_1 { get; set; }

        public string MODULE_ID { get; set; }

        public List<S7F10_LIST_1> LIST_1 { get; set; }

        public S7F10_MaterialIDData_Model()
        {
            this.Stream = 7;
            this.Function = 10;
            this.FullName = "MaterialIDData";
            this.Name = "MaterialIDData";
            this.SubName = "";
            this.IsUnDefined = false;

            this.UINT1_1 = 0;
            this.MODULE_ID = string.Empty;
            this.LIST_1 = new List<S7F10_LIST_1>();
        }
    }

    public class S7F10_LIST_1
    {
