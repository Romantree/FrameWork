...
{
    public class S6F11_EventReportSend_JobProcessEvent_Model : IXComModel
    {
        ...
        public List<S6F11_JobProcessEvent_LIST_1> JobProcessEvent_LIST_1 { get; set; }

        public S6F11_EventReportSend_JobProcessEvent_Model()
        {
            this.Stream = 6;
            this.Function = 11;
            this.FullName = "EventReportSend - JobProcessEvent";
            this.Name = "EventReportSend";
            this.SubName = "JobProcessEvent";
            ...
            this.BATCH_ORDER = 0;
            this.RPTID_4 = 0;
            this.JobProcessEvent_LIST_1 = new List<S6F11_JobProcessEvent_LIST_1>();
        }
    }

    public class S6F11_JobProcessEvent_LIST_1
    {
        ...
        public S6F11_JobProcessEvent_LIST_1()
        {
