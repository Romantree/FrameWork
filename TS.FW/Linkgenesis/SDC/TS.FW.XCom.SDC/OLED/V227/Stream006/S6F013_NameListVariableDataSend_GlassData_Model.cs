...
{
    public class S6F13_NameListVariableDataSend_GlassData_Model : IXComModel
    {
        ...
        public List<S6F13_GlassData_LIST_1> GlassData_LIST_1 { get; set; }

        public Byte RPTID_2 { get; set; }

        public List<S6F13_GlassData_LIST_2> GlassData_LIST_2 { get; set; }

        public Byte RPTID_3 { get; set; }

        public List<S6F13_GlassData_LIST_4> GlassData_LIST_4 { get; set; }

        public S6F13_NameListVariableDataSend_GlassData_Model()
        {
            this.Stream = 6;
            this.Function = 13;
            this.FullName = "NameListVariableDataSend - GlassData";
            this.Name = "NameListVariableDataSend";
            this.SubName = "GlassData";
            this.IsUnDefined = false;

            this.DATA_ID = 0;
            this.CEID = 0;
            this.RPTID_1 = 0;
            this.GlassData_LIST_1 = new List<S6F13_GlassData_LIST_1>();
            this.RPTID_2 = 0;
            this.GlassData_LIST_2 = new List<S6F13_GlassData_LIST_2>();
            this.RPTID_3 = 0;
            this.GlassData_LIST_4 = new List<S6F13_GlassData_LIST_4>();
        }
    }

    public class S6F13_GlassData_LIST_1
    {
    ...
    public class S6F13_GlassData_LIST_2
    {
        public string MODULE_ID { get; set; }

        public List<S6F13_GlassData_LIST_3> GlassData_LIST_3 { get; set; }

        public S6F13_GlassData_LIST_2()
        {
            this.MODULE_ID = string.Empty;
            this.GlassData_LIST_3 = new List<S6F13_GlassData_LIST_3>();
        }
    }

    public class S6F13_GlassData_LIST_3
    {
        public string ITEM_NAME { get; set; }

        public string ITEM_VALUE { get; set; }

        public S6F13_GlassData_LIST_3()
        {
