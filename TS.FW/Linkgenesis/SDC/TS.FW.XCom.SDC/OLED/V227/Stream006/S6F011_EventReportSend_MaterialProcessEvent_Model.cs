...
{
    public class S6F11_EventReportSend_MaterialProcessEvent_Model : IXComModel
    {
        ...
        public List<S6F11_MaterialProcessEvent_LIST_1> MaterialProcessEvent_LIST_1 { get; set; }

        public S6F11_EventReportSend_MaterialProcessEvent_Model()
        {
            this.Stream = 6;
            this.Function = 11;
            this.FullName = "EventReportSend - MaterialProcessEvent";
            this.Name = "EventReportSend";
            this.SubName = "MaterialProcessEvent";
            ...
            this.RPTID_2 = 0;
            this.MaterialProcessEvent_LIST_1 = new List<S6F11_MaterialProcessEvent_LIST_1>();
        }
    }

    public class S6F11_MaterialProcessEvent_LIST_1
    {
        ...
        public List<S6F11_MaterialProcessEvent_LIST_2> MaterialProcessEvent_LIST_2 { get; set; }

        public S6F11_MaterialProcessEvent_LIST_1()
        {
            ...
            this.MaterialProcessEvent_LIST_2 = new List<S6F11_MaterialProcessEvent_LIST_2>();
        }
    }

    public class S6F11_MaterialProcessEvent_LIST_2
    {
        ...
        public S6F11_MaterialProcessEvent_LIST_2()
        {
