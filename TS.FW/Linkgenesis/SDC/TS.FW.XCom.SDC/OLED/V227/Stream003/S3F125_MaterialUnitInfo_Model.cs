...
{
    public class S3F125_MaterialUnitInfo_Model : IXComModel
    {
        ...
        public List<S3F125_LIST_1> LIST_1 { get; set; }

        public S3F125_MaterialUnitInfo_Model()
        {
            this.Stream = 3;
            this.Function = 125;
            this.FullName = "MaterialUnitInfo";
            this.Name = "MaterialUnitInfo";
            this.SubName = "";
            ...
            this.BATCH_ORDER = 0;
            this.LIST_1 = new List<S3F125_LIST_1>();
        }
    }

    public class S3F125_LIST_1
    {
        ...
        public List<S3F125_LIST_2> LIST_2 { get; set; }

        public S3F125_LIST_1()
        {
            ...
            this.LIST_2 = new List<S3F125_LIST_2>();
        }
    }

    public class S3F125_LIST_2
    {
