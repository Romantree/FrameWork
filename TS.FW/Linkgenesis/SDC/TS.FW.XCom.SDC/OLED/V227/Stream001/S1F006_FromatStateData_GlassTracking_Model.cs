...
{
    public class S1F6_FromatStateData_GlassTracking_Model : IXComModel
    {
        ...
        public S1F6_FromatStateData_GlassTracking_Model()
        {
            this.Stream = 1;
            this.Function = 6;
            this.FullName = "FromatStateData - GlassTracking";
            this.Name = "FromatStateData";
            this.SubName = "GlassTracking";
