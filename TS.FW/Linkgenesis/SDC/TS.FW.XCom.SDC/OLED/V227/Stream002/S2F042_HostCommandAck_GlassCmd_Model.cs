...
{
    public class S2F42_HostCommandAck_GlassCmd_Model : IXComModel
    {
        ...
        public List<S2F42_GlassCmd_LIST_1> GlassCmd_LIST_1 { get; set; }

        public Byte CPACK_3 { get; set; }

        public S2F42_HostCommandAck_GlassCmd_Model()
        {
            this.Stream = 2;
            this.Function = 42;
            this.FullName = "HostCommandAck - GlassCmd";
            this.Name = "HostCommandAck";
            this.SubName = "GlassCmd";
            ...
            this.GlassCmd_LIST_1 = new List<S2F42_GlassCmd_LIST_1>();
            this.CPACK_3 = 0;
        }
    }

    public class S2F42_GlassCmd_LIST_1
    {
        public Byte SLOT_NO { get; set; }

        public S2F42_GlassCmd_LIST_1()
        {
            this.SLOT_NO = 0;
        }
    }
