...
namespace TS.FW.XCom.SDC.OLED.V227
{
    public class S7F107_PPBodyModifyReport_Model : IXComModel
    {
        ...
        public List<S7F107_LIST_1> LIST_1 { get; set; }
        ...
        public S7F107_PPBodyModifyReport_Model()
        {
            ...
            this.PPID_TYPE = 0;
            this.LIST_1 = new List<S7F107_LIST_1>();
        }
    }

    public class S7F107_LIST_1
    {
        public Int32 CCODE { get; set; }

        public List<S7F107_LIST_2> LIST_2 { get; set; }

        public S7F107_LIST_1()
        {
            this.CCODE = 0;
            this.LIST_2 = new List<S7F107_LIST_2>();
        }
    }

    public class S7F107_LIST_2
    {
        public string P_PARM_NAME { get; set; }

        public string P_PARM { get; set; }

        public S7F107_LIST_2()
        {
