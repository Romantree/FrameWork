...
namespace TS.FW.GIGA.Networks
{
    public class NetUvLamp : INetSerialPort
    {
        ...
        private bool IsUvLampIO => true; // DB.Network.UvLampOption.IO;

        private int UvLampTempLimit => 100; // DB.Network.UvLampOption.TempLimit;

        public int Retry { get; set; } = 0;

        public UvLampData Data { get; private set; } = new UvLampData();

        public bool LedOn => Data.LedOn; // IsUvLampIO ? AP.IO.UV_LAMP_RUN : Data.LedOn;

        public bool Cooling => false; // AP.IO.UV_LAMP_COLLING;
