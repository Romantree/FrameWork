...
{
    public class S2F30_EQConstantNamelist_Model : IXComModel
    {
        public string MODULE_ID { get; set; }

        public List<S2F30_LIST_1> LIST_1 { get; set; }

        public S2F30_EQConstantNamelist_Model()
        {
            this.Stream = 2;
            this.Function = 30;
            this.FullName = "EQConstantNamelist";
            this.Name = "EQConstantNamelist";
            this.SubName = "";
            this.IsUnDefined = false;

            this.MODULE_ID = string.Empty;
            this.LIST_1 = new List<S2F30_LIST_1>();
        }
    }

    public class S2F30_LIST_1
    {
