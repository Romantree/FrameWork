...
{
    public class S2F15_NewEquipmentConstantSend_Model : IXComModel
    {
        public string MODULEID { get; set; }

        public List<S2F15_ECIDs> ECIDs { get; set; }

        public S2F15_NewEquipmentConstantSend_Model()
        {
            this.Stream = 2;
            this.Function = 15;
            this.FullName = "NewEquipmentConstantSend";
            this.Name = "NewEquipmentConstantSend";
            this.SubName = "";
            this.IsUnDefined = false;

            this.MODULEID = string.Empty;
            this.ECIDs = new List<S2F15_ECIDs>();
        }
    }

    public class S2F15_ECIDs
    {
