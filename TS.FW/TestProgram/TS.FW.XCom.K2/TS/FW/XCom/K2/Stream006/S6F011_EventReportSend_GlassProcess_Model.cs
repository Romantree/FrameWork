...
{
    public class S6F11_EventReportSend_GlassProcess_Model : IXComModel
    {
        ...
        public List<S6F11_GlsProcCnt> GlsProcCnt { get; set; }

        public S6F11_EventReportSend_GlassProcess_Model()
        {
            this.Stream = 6;
            this.Function = 11;
            this.FullName = "EventReportSend_GlassProcess";
            this.Name = "EventReportSend_GlassProcess";
            this.SubName = "";
            ...
            this.RPTID2 = 0;
            this.GlsProcCnt = new List<S6F11_GlsProcCnt>();
        }
    }

    public class S6F11_GlsProcCnt
    {
