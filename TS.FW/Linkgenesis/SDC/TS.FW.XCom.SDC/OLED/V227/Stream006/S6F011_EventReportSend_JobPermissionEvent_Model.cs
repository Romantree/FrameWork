...
{
    public class S6F11_EventReportSend_JobPermissionEvent_Model : IXComModel
    {
        ...
        public List<S6F11_JobPermissionEvent_LIST_1> JobPermissionEvent_LIST_1 { get; set; }

        public S6F11_EventReportSend_JobPermissionEvent_Model()
        {
            this.Stream = 6;
            this.Function = 11;
            this.FullName = "EventReportSend - JobPermissionEvent";
            this.Name = "EventReportSend";
            this.SubName = "JobPermissionEvent";
            ...
            this.BATCH_ORDER = 0;
            this.RPTID_4 = 0;
            this.JobPermissionEvent_LIST_1 = new List<S6F11_JobPermissionEvent_LIST_1>();
        }
    }

    public class S6F11_JobPermissionEvent_LIST_1
    {
        public Byte EOID { get; set; }

        public List<S6F11_JobPermissionEvent_LIST_2> JobPermissionEvent_LIST_2 { get; set; }

        public S6F11_JobPermissionEvent_LIST_1()
        {
            this.EOID = 0;
            this.JobPermissionEvent_LIST_2 = new List<S6F11_JobPermissionEvent_LIST_2>();
        }
    }

    public class S6F11_JobPermissionEvent_LIST_2
    {
        public Byte EOMD { get; set; }

        public Byte EOV { get; set; }

        public S6F11_JobPermissionEvent_LIST_2()
        {
            this.EOMD = 0;
            this.EOV = 0;
        }
